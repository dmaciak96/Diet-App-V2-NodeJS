...
public class BmiForm extends FormLayout {
    ...
    public BmiForm(BmiRequest bmi) {
        ...
        this.binder = new BeanValidationBinder<>(BmiRequest.class);
    ...
    public static abstract class BmiFormEvent extends ComponentEvent<BmiForm> {
        ...
        private final BmiRequest bmiRequest;

        protected BmiFormEvent(BmiForm source, BmiRequest bmiRequest) {
            super(source, false);
    ...
    public static class SaveEvent extends BmiForm.BmiFormEvent {
        SaveEvent(BmiForm source, BmiRequest bmi) {
            super(source, bmi);
        }
    }
