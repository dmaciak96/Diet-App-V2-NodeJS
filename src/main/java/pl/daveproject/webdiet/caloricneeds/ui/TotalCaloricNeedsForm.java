...
import pl.daveproject.webdiet.caloricneeds.model.ActivityLevel;
import pl.daveproject.webdiet.caloricneeds.model.Gender;
...
public class TotalCaloricNeedsForm extends FormLayout {
    ...
    private final Binder<TotalCaloricNeedsRequest> binder;
    ...
    public TotalCaloricNeedsForm(TotalCaloricNeedsRequest totalCaloricNeeds) {
        ...
        this.binder = new BeanValidationBinder<>(TotalCaloricNeedsRequest.class);
    ...
    public static abstract class TotalCaloricNeedsFormEvent extends ComponentEvent<TotalCaloricNeedsForm> {
        ...
        private final TotalCaloricNeedsRequest totalCaloricNeedsRequest;

        protected TotalCaloricNeedsFormEvent(TotalCaloricNeedsForm source, TotalCaloricNeedsRequest totalCaloricNeedsRequest) {
            super(source, false);
            this.totalCaloricNeedsRequest = totalCaloricNeedsRequest;
        }
    }

    public static class SaveEvent extends TotalCaloricNeedsForm.TotalCaloricNeedsFormEvent {
        SaveEvent(TotalCaloricNeedsForm source, TotalCaloricNeedsRequest totalCaloricNeeds) {
